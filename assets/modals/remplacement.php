<div class="modal fade" id="remplacementModal" tabindex="-1" aria-labelledby="remplacementModalLabel" aria-hidden="true">
    <div class="modal-dialog m-lg-5 m-md-3 m-sm-1">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="remplacementModalLabel">Remplacement des Humains</h1>
            ...
            <div class="modal-body container">
                        ...
                        <div class="card mb-2">
                            ...
                            <div class="card-body">
                                <a href="https://www.nouvelleviepro.fr/34-metiers-qui-ne-seront-pas-remplaces-par-ia">
                                    <h5 class="card-title">Quels métiers ne seront pas remplacés par les IA</h5>
                                </a>
                                <p class="card-text">Les métiers qui ont le moins de risque d'être remplacés</p>
                            </div>
                            <div class="card-footer bg-body-tertiary border-0">
                                <small class="text-body-secondary">Nouvelleviepro</small>
                            </div>
                        </div>
                    </div>
                    <div class="col d-flex align-items-stretch">
                    ...
                    <div class="col d-flex align-items-stretch">
                        <div class="card mb-2">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Voici les différents métiers les plus suspceptibles d'être remplacés à cause de l'IA.</p>
                            </div>
                            <div class="card-footer bg-body-tertiary border-0">
                ...
                <div class="row mx-1">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Plus d'informations sur les différents métiers susceptibles d'être remplacés</h4>
